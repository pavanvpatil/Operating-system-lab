               ...
               int cpu)
{
  ...
  if (quantum < 1 && quantum != -1)
    return (EINVAL);
  unsigned cpu_total_time = p->p_quantum_size_ms;
  unsigned cpu_time_used = cpu_total_time - cpu_time_2_ms(p->p_cpu_time_left);
  printf("MINIX: 200030041 200010022 Alloted CPU quantum: %d, CPU quantum used: %d\n", cpu_total_time, cpu_time_used);
