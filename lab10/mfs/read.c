...
//------------Lab-10-------------------------------------
static void removeInodeEntry(struct inode *rip); // function prototype for removeInodeEntry
//------------Lab-10-------------------------------------
...
int fs_readwrite(void)
{
	...
	if (immediate == 1)
	{
		if (rw_flag == READING)
		{
			...
			printf("\nMinix-200030041_200010022 -> reading from an immediate file:\n");
			...
			printf("\n\nMinix-200030041_200010022 -> contents of the immediate file are:\n\n");
			...
			printf("\n\nMinix-200030041_200010022 -> immediate file successfully read\n\n");
			if (r == OK)
			{
				nrbytes = 0;
				cum_io += f_size;
		...
		{
			printf("\nMinix-200030041_200010022 -> writing into an immediate file\n");
			...
			printf("\nMinix-200030041_200010022 -> immediate file successfully written\n");
		}
	}
	//------------Lab-10-------------------------
 ...
 *				removeInodeEntry			     *
 *===========================================================================*/
static void removeInodeEntry(rip) register struct inode *rip; /*inode to be erased */
{
	register int i;
	rip->i_size = 0;
